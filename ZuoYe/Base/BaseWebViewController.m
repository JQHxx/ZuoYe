...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.baseTitle = kIsEmptyString(self.webTitle)?@"":self.webTitle;
...
-(WKWebView *)rootWebView{
    if (_rootWebView==nil) {
        _rootWebView=[[WKWebView alloc] initWithFrame:CGRectMake(0, kNavHeight+6, kScreenWidth, kScreenHeight-kNavHeight-6)];
