...
- (void)setupToolbars
{
    ...
    _indexLabel.hidden = self.imageCount<2;
}
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if ([self.sourceImagesContainerView isKindOfClass:[iCarousel class]]){
        ...
        MyLog(@"photoClick--sourceView:%@",sourceView);
...
- (void)showFirstImage
{
    ...
    if ([self.sourceImagesContainerView isKindOfClass:UICollectionView.class]) {
        ...
        sourceView = self.sourceImagesContainerView;
    }else if ([self.sourceImagesContainerView isKindOfClass:[iCarousel class]]){
        iCarousel *carousel = (iCarousel *)self.sourceImagesContainerView;
        UIView *selectView = [carousel itemViewAtIndex:self.currentImageIndex];
        sourceView = [selectView viewWithTag:self.currentImageIndex+1000];
    }else{
        sourceView = self.sourceImagesContainerView.subviews[self.currentImageIndex];
    }
    MyLog(@"showFirstImage--sourceView:%@",sourceView);
