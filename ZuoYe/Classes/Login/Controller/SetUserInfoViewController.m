...
- (void)viewDidLoad {
    ...
    gradesArray = @[@"一年级",@"二年级",@"三年级",@"四年级",@"五年级",@"六年级",@"初一",@"初二",@"初三"];
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component{
    NSString *str = [gradesArray objectAtIndex:row];
...
-(void)confirmSetUserInfoAction{
    ...
    NSString *gradeStr = gradesArray[selIndex];
    MyLog(@"grade：%@",gradeStr);
...
-(void)initSetUserInfoView{
    ...
    UIButton *confirmButton = [[LoginButton alloc] initWithFrame:CGRectMake(48.0, self.pickerView.bottom+37.0,kScreenWidth-95.0, (kScreenWidth-95.0)*(128.0/588.0)) title:@"确定"];
